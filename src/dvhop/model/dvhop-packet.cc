...
namespace ns3
{
  namespace dvhop
  {
    ...
    FloodingHeader::FloodingHeader(double xPos, double yPos, uint16_t seqNo, uint16_t hopCount, Ipv4Address beacon)
    {
      ...
      m_seqNo    = seqNo;
      m_hopCount = hopCount;
      std::cout << "Test FloodingHeader: hopCount: " << hopCount << std::endl;
      std::cout << "Test FloodingHeader: m_hopCount: " << m_hopCount << std::endl;
      m_beaconId = beacon;
    }
    ...
    FloodingHeader::Serialize (Buffer::Iterator start) const
    {
      ...
      std::cout << "Test Serialize: m_hopCount: " << m_hopCount << std::endl;
    ...
    FloodingHeader::Deserialize (Buffer::Iterator start)
    {
      ...
      std::cout << "Test Deserialize: m_hopCount: " << m_hopCount << std::endl;
