...
// Copy UDP echo broadcasting code 
// modify code for dvhop function

// Libraries included from udp-echo.cc
#include <fstream>
...
int main(int argc, char *argv[])  {
  ...
  // set maximum transmission distance which will be equivalent to average hop distance
  Config::SetDefault ("ns3::RangePropagationLossModel::MaxRange", DoubleValue (avgHopDistance));
